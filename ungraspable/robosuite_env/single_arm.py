...
import os
import copy
from ungraspable.robosuite_env.osc import OSC
...
class SingleArm(Manipulator):
    ...
    def reset(self, deterministic=False):
        ...
        if not deterministic:
            ...
            if self.has_gripper:
                ...
                ] = np.array([0.04, -0.04])  # start with open gripper instead of self.gripper.init_qpos
    ...
    def control(self, action, policy_step=False):
        ...
        if self.control_gripper:
            ...
            # Keep gripper open
            self.grip_action(gripper=self.gripper, gripper_action=[-1])
